...
BasicGame.Game.prototype = {
  ...
  setupPlayer: function(){
    ...
    this.player.body.setSize(25, 25, 0, -3);
    this.weaponLevel = 0;
  },
  ...
  // white enemy
    ...
    this.shooterPool.setAll('dropRate', 0.99, false, false, 0, true);
  ...
  setupText: function(){ //singe
    this.instructions = this.add.text( -5100, 600,
  ...
  spawnEnemies: function () {
    ...
    if (this.nextShooterAt < this.time.now && this.shooterPool.countDead() > 0) {
      ...
      shooter.rotation = this.physics.arcade.moveToXY(shooter, target, 768, this.rnd.integerInRange(30, 80)) - Math.PI / 2;
      shooter.play('fly');
